...
var text_lines = [
"Teacher: Your thesis on memory management—brilliant! Explain the allocator algorithm again?
",
"I freeze. *// Generated by GPT-5.*",
"Cassy: It’s… recursive
",
"I lie"
]
