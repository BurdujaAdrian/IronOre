...
var text_lines = [
"Cassy graduates, her language a footnote in forum threads.",
"But in the glow of a dozen monitors, she rebuilds it—cleaner, wiser, hers.",
"This time, the bugs taste like beginnings."
]
