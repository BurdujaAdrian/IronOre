...
var text_lines = [
"I shelve the thesis: “Designing a Minimalist Parser for Educational Use.” A librarian stamps it, yawns.
",
"On page 42, scribbled in red ink: // TODO: Fix register allocation.
"]
