...
var text_lines = [
"The final exam paper stares back—*C-*. Average. Unremarkable. The professor drones about job market strategies. I crumple the grade sheet, my compiler’s last commit still rotting in my GitHub: v0.7.3 (unstable).
"]
