...
var text_lines = [
"Cassy ships buttons, not compilers. On sleepless nights, she wonders about PHI nodes—then dismisses it as “backend stuff.” The dream flickers, fades, and dies in a sea of pixels. The parse tree withers, unrooted.
"]
