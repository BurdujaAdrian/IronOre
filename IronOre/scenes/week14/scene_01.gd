...
var text_lines = [
"The final grade notification pings. I clutch the phone, breath held.
",
"Pass. Pass. Pass.
",
"I sink to the floor. The compiler’s icon glows on my desktop—v1.0.3, downloaded seventeen times. Mostly me.
"]
