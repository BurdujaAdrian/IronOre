...
var text_lines = [
"The lecture hall hums with the static of a hundred buzzing laptops. I sit rigid in the back row, glaring at my half-written lexer onscreen. Waste of time, I think. But the guest’s name glows on the projector—Liam Vogt. Creator of Nyx. The compiler that redefined embedded systems."
]
