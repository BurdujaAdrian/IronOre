...
var text_lines = [
"The party invite glows on my phone like a rogue semicolon. I silence it.",

"Sleep. Shower. Eat something that isn’t gas station sushi.",

"My desk is a warzone of energy drink cans and syntax diagrams. I sweep them aside, plug in a lavender diffuser I’ve never used, and collapse onto the bed.
",
"No code. No deadlines. Just silence.",

"A notification buzzes—“Assignment due tomorrow.” I bury the phone under a pillow.
",
"“You’re not a machine,” I whisper, echoing Professor Hayes. The words taste foreign, sweet. Permission.
",
"I order ramen. Watch trashy TV. At midnight, I dream of beaches, not bytecode.
",]
